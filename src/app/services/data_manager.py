...
class DataManager:
    ...
    def load_or_create(self, folder_path):
        ...
        if os.path.exists(self.data_path):
            self.df = pd.read_excel(self.data_path, dtype={col: "string" for col in self.required_cols})
    ...
    def prepare_update_values(self, new_image_name: str, form_label_values: dict) -> dict:
